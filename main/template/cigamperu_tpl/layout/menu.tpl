...
<nav class="navbar navbar-default">
    <div class="container ddt-container-style">
        <div class="navbar-header">
            ...
            {% if _u.logged == 1 and notification_event == 1 %}
                ...
                {% endif %}
            {% endif %}
            <a class="navbar-brand" href="{{ _p.web }}"><em class="fa fa-home"></em> Capacitaciones CIGAM</a>
        </div>
        
        <div id="ddt-navbar-logo"class="nav navbar-nav text-center">
            <div class="ddt-container-logo">
                <div class="logo">
                    {{ logo }}
                </div>
            </div>
