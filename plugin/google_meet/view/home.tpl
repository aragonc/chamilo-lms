    ...
    <div class="col-md-12">
        <div class="meets">
            <div class="">
                ...
                {% if global_meet == true %}
                    <h3>Configurar Meet Globales</h3>
                    <a href="{{ url_add_room_global }}" class="btn btn-success btn-add-meet">
                                        ...
                                        <div class="card-info">
                                            ...
                                            <div class="float-right">
                                                ...
                                                <div class="btn-group btn-group-xs" role="group" aria-label="...">
                                                    <a class="btn btn-sm btn-default" href="meets_global.php?action=edit&id_meet={{ meet.id }}&{{ _p.web_cid_query }}">
                                                        <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    </a>
                                                    <a class="btn btn-sm btn-default"
                                                       onclick="javascript:if(!confirm('{{ 'AreYouSureToDelete' | get_lang }}')) return false;"
                                                       href="meets_global.php?action=delete&id_meet={{ meet.id }}&{{ _p.web_cid_query }}">
